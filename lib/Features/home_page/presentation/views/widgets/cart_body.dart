                  ...
                  children: [
                     Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomPriceRow(text: "Item total", price: BlocProvider.of<CartCubit>(context).totalPrice.toString()+r'$',style: Styles.fontSize20.copyWith(
                     ...
                     CustomPriceRow(text:"total",price: '${BlocProvider.of<CartCubit>(context).totalPrice+40+50}',style: Styles.fontSize24.copyWith(
                      color: Colors.white.withOpacity(0.7),
                    )),
